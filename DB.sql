...
CREATE TABLE [dbo].[asset] (
  ...
  [asset_name] varchar(255) COLLATE Chinese_PRC_CI_AS  NULL,
  [equipment_no] varchar(200) COLLATE Chinese_PRC_CI_AS  NULL,
  [asset_price] money  NULL,
  [count] int  NULL,
...
INSERT INTO [dbo].[asset] ([asset_id], [user_id], [asset_type_id], [asset_name], [equipment_no], [asset_price], [count], [create_time], [update_time], [description], [registrant]) VALUES (N'1', N'2', N'1', N'电脑', N'PC0011', N'5011.0000', N'11', N'2019-06-20 17:04:10', N'2019-06-26 10:39:14', N'测试修改描述信息', N'Logan')
GO

INSERT INTO [dbo].[asset] ([asset_id], [user_id], [asset_type_id], [asset_name], [equipment_no], [asset_price], [count], [create_time], [update_time], [description], [registrant]) VALUES (N'2', N'1', N'2', N'测试数据2', N'PC002', N'4000.0000', N'1', N'2019-06-20 17:04:38', N'2019-06-25 12:11:42', N'', N'122')
GO

INSERT INTO [dbo].[asset] ([asset_id], [user_id], [asset_type_id], [asset_name], [equipment_no], [asset_price], [count], [create_time], [update_time], [description], [registrant]) VALUES (N'3', N'2', N'3', N'键鼠一套', N'logitech', N'50.0000', N'1', N'2019-06-20 17:33:22', N'2019-06-26 10:39:58', N'罗技键鼠一套', N'Logan')
GO

INSERT INTO [dbo].[asset] ([asset_id], [user_id], [asset_type_id], [asset_name], [equipment_no], [asset_price], [count], [create_time], [update_time], [description], [registrant]) VALUES (N'4', N'2', N'1', N'测试数据4', N'PC004', N'2500.0000', N'1', N'2019-06-20 17:33:44', NULL, NULL, NULL)
GO

INSERT INTO [dbo].[asset] ([asset_id], [user_id], [asset_type_id], [asset_name], [equipment_no], [asset_price], [count], [create_time], [update_time], [description], [registrant]) VALUES (N'14', N'3', N'2', N'Test001', N'TEST001', N'999.0000', N'1', N'2019-06-21 15:23:49', NULL, N'测试前台新增数据', NULL)
GO

INSERT INTO [dbo].[asset] ([asset_id], [user_id], [asset_type_id], [asset_name], [equipment_no], [asset_price], [count], [create_time], [update_time], [description], [registrant]) VALUES (N'20', N'1', N'1', N'测试数据1', N'PC001', N'5000.0000', N'1', N'2019-06-24 15:59:11', N'2019-06-24 16:04:52', N'测试修改信息描述111', NULL)
GO

INSERT INTO [dbo].[asset] ([asset_id], [user_id], [asset_type_id], [asset_name], [equipment_no], [asset_price], [count], [create_time], [update_time], [description], [registrant]) VALUES (N'21', N'3', N'3', N'美工刀', N'MGD001', N'5.0000', N'1', N'2019-06-26 10:03:56', NULL, N'我是描述', N'Logan')
GO

INSERT INTO [dbo].[asset] ([asset_id], [user_id], [asset_type_id], [asset_name], [equipment_no], [asset_price], [count], [create_time], [update_time], [description], [registrant]) VALUES (N'26', N'1', N'1', N'1111111111', N'111111111', N'4.0000', N'2', N'2019-06-26 10:20:01', NULL, N'12312', N'1111111')
GO
...
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[asset_type]') AND type IN ('U'))
	DROP TABLE [dbo].[asset_type]
GO

CREATE TABLE [dbo].[asset_type] (
  [asset_type_id] int  IDENTITY(1,1) NOT NULL,
  [asset_type_name] varchar(255) COLLATE Chinese_PRC_CI_AS  NULL
)
GO

ALTER TABLE [dbo].[asset_type] SET (LOCK_ESCALATION = TABLE)
GO
...
INSERT INTO [dbo].[asset_type] ([asset_type_id], [asset_type_name]) VALUES (N'15', N'测试数据A')
GO

INSERT INTO [dbo].[asset_type] ([asset_type_id], [asset_type_name]) VALUES (N'1', N'电脑')
GO

INSERT INTO [dbo].[asset_type] ([asset_type_id], [asset_type_name]) VALUES (N'3', N'工具')
GO

INSERT INTO [dbo].[asset_type] ([asset_type_id], [asset_type_name]) VALUES (N'20', N'公文包')
GO

INSERT INTO [dbo].[asset_type] ([asset_type_id], [asset_type_name]) VALUES (N'2', N'文具')
GO
...
-- ----------------------------
ALTER TABLE [dbo].[asset] ADD CONSTRAINT [PK__asset__735BA463851C2B47] PRIMARY KEY CLUSTERED ([asset_id])
...
-- ----------------------------
-- Uniques structure for table asset_type
-- ----------------------------
ALTER TABLE [dbo].[asset_type] ADD CONSTRAINT [UQ__asset__543C4FD975DD8546] UNIQUE NONCLUSTERED ([asset_type_name] ASC)
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
-- Primary Key structure for table asset_type
-- ----------------------------
ALTER TABLE [dbo].[asset_type] ADD CONSTRAINT [PK__asset__3213E83F1A20D870] PRIMARY KEY CLUSTERED ([asset_type_id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[asset] ADD CONSTRAINT [FK__asset__proper__0D7A0286] FOREIGN KEY ([asset_type_id]) REFERENCES [dbo].[asset_type] ([asset_type_id]) ON DELETE NO ACTION ON UPDATE NO ACTION
GO
